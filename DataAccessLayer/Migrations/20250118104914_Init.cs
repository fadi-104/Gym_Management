    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TraineeData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TraineeData_AspNetUsers_TraineeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainerAppointments_AspNetUsers_TrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_UserAppointments_TrainerAppointments_appoId",
                        column: x => x.appoId,
                        principalTable: "TrainerAppointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ExercisId = table.Column<int>(type: "int", nullable: true),
                    SetNumber = table.Column<int>(type: "int", nullable: false),
                    RepsNumber = table.Column<int>(type: "int", nullable: false),
                    Weight = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkoutDatas_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerSubscriptions_TraineeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAppointments_appoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutDatas_ExercisId",
                table: "WorkoutDatas",
                column: "ExercisId");
